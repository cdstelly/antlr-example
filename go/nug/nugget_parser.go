...
var parserATN = []uint16{
	3, 24715, 42794, 33075, 47597, 16764, 15335, 30598, 22884, 3, 31, 201,
	...
	59, 60, 8, 3, 1, 2, 60, 61, 7, 27, 2, 2, 61, 62, 7, 3, 2, 2, 62, 63, 5,
	...
	72, 70, 3, 2, 2, 2, 73, 74, 7, 27, 2, 2, 74, 75, 7, 3, 2, 2, 75, 76, 7,
	27, 2, 2, 76, 7, 3, 2, 2, 2, 77, 78, 7, 27, 2, 2, 78, 79, 7, 3, 2, 2, 79,
	80, 7, 27, 2, 2, 80, 81, 7, 4, 2, 2, 81, 85, 5, 26, 14, 2, 82, 84, 5, 10,
	6, 2, 83, 82, 3, 2, 2, 2, 84, 87, 3, 2, 2, 2, 85, 83, 3, 2, 2, 2, 85, 86,
	3, 2, 2, 2, 86, 120, 3, 2, 2, 2, 87, 85, 3, 2, 2, 2, 88, 89, 7, 27, 2,
	2, 89, 90, 7, 3, 2, 2, 90, 91, 7, 27, 2, 2, 91, 92, 7, 4, 2, 2, 92, 93,
	...
	108, 7, 27, 2, 2, 108, 109, 7, 3, 2, 2, 109, 110, 7, 27, 2, 2, 110, 111,
	7, 4, 2, 2, 111, 112, 5, 26, 14, 2, 112, 116, 7, 27, 2, 2, 113, 115, 5,
	...
	27, 2, 2, 136, 138, 3, 2, 2, 2, 137, 121, 3, 2, 2, 2, 137, 123, 3, 2, 2,
	2, 137, 133, 3, 2, 2, 2, 138, 11, 3, 2, 2, 2, 139, 140, 7, 6, 2, 2, 140,
	141, 7, 27, 2, 2, 141, 142, 7, 7, 2, 2, 142, 143, 7, 27, 2, 2, 143, 13,
	3, 2, 2, 2, 144, 147, 5, 16, 9, 2, 145, 147, 5, 18, 10, 2, 146, 144, 3,
	2, 2, 2, 146, 145, 3, 2, 2, 2, 147, 15, 3, 2, 2, 2, 148, 149, 7, 8, 2,
	2, 149, 150, 7, 27, 2, 2, 150, 151, 7, 8, 2, 2, 151, 17, 3, 2, 2, 2, 152,
	153, 5, 20, 11, 2, 153, 154, 7, 28, 2, 2, 154, 155, 5, 22, 12, 2, 155,
	19, 3, 2, 2, 2, 156, 157, 9, 2, 2, 2, 157, 21, 3, 2, 2, 2, 158, 159, 7,
	8, 2, 2, 159, 160, 7, 29, 2, 2, 160, 161, 7, 8, 2, 2, 161, 23, 3, 2, 2,
	2, 162, 163, 9, 3, 2, 2, 163, 25, 3, 2, 2, 2, 164, 165, 9, 4, 2, 2, 165,
	27, 3, 2, 2, 2, 166, 167, 7, 8, 2, 2, 167, 168, 7, 27, 2, 2, 168, 171,
	7, 8, 2, 2, 169, 171, 7, 27, 2, 2, 170, 166, 3, 2, 2, 2, 170, 169, 3, 2,
	2, 2, 171, 29, 3, 2, 2, 2, 172, 177, 7, 27, 2, 2, 173, 174, 7, 5, 2, 2,
	174, 176, 7, 27, 2, 2, 175, 173, 3, 2, 2, 2, 176, 179, 3, 2, 2, 2, 177,
	...
	2, 185, 31, 3, 2, 2, 2, 186, 192, 7, 27, 2, 2, 187, 188, 7, 9, 2, 2, 188,
	189, 5, 32, 17, 2, 189, 190, 7, 9, 2, 2, 190, 192, 3, 2, 2, 2, 191, 186,
	3, 2, 2, 2, 191, 187, 3, 2, 2, 2, 192, 33, 3, 2, 2, 2, 193, 194, 7, 27,
	2, 2, 194, 35, 3, 2, 2, 2, 195, 196, 7, 14, 2, 2, 196, 197, 7, 10, 2, 2,
	197, 198, 7, 26, 2, 2, 198, 199, 7, 11, 2, 2, 199, 37, 3, 2, 2, 2, 16,
...
var symbolicNames = []string{
	...
	"JOIN", "WS", "NUMBER", "StrLit", "OPERATION", "DATE", "ROOT", "ATTR_LIST",
}
...
const (
	...
	NuggetParserJOIN      = 22
	NuggetParserWS        = 23
	NuggetParserNUMBER    = 24
	NuggetParserStrLit    = 25
	NuggetParserOPERATION = 26
	NuggetParserDATE      = 27
	NuggetParserROOT      = 28
	NuggetParserATTR_LIST = 29
)
